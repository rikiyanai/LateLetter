...
#
# `COMPOSITION_VERSION` is the version of the accepted content recipe: the
# population the operator actually reviewed and approved. It answers "is this
# the composition the operator said yes to".
#
# Why they cannot be one number: a stored world can be perfectly parseable
# (schema current), built by an old generator, and hold a composition nobody
# ever approved -- all three at once. Held in one field, an obsolete starter
# reads as today's candidate, which is exactly how a persisted 13-plant /
# 22-fixture / 4-animal / 8-collectible world came to be reviewed as though it
# were the current 8/10/4/3 starter.
GENERATOR_VERSION = 1
